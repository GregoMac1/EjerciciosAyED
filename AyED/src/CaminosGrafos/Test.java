...
public class Test { //bien. funciona y esta corregido
	public static void main(String[] args) {
		...
		BuscadorDeCaminos<String> buscador = new BuscadorDeCaminos<String>(grafo);
		
		//ListaGenerica<String> caminoMin = buscador.caminoMinimo("F", "D");		
		//System.out.println(caminoMin.toString());
		
		ListaGenerica<ListaGenerica<String>> todos = buscador.todosLosCaminos("F", "D");
		while (!todos.fin())
			System.out.println(todos.proximo().toString());
	}
}
